function [Epsout,Lmin,Lot,runlmax,Lttot]=compute_overturns(p,t,c,lat,usetemp,minotsize,sigma,runlmin);
...
if ~exist('sigma')|isempty(sigma); sigma=1e-6; end
if ~exist('runlmin')|isempty(runlmin); runlmin=2; end
