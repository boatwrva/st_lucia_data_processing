function time = hex_time_sproul(castnumber,totalscans)
...
% 
datadir='/Users/kerstin/Desktop/SIO_year_4/MPL_intern/SP2412/ctd/data/'; %datadir='/Users/jen/projects/kerstin_sproul/raw_data/';
ctdlist = dir(fullfile(datadir,'SP2412_CTD1.hex'));%ctdlist = dirs(fullfile(datadir,'SP2403_CTD*.hdr'));
