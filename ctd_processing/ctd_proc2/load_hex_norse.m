function load_hex_arcticMix(icast)
...
datadir='/Users/jen/projects/niskin/cruise/data/ctd/';
datadir='/Users/jen/projects/norse/norsecruise_22/data/ctd/';
...
xmlname= [datadir outname(1:end-11) 'CTD' outname(end-6:end-3) 'XMLCON']
...
data1.time = hex_time_norse(icast,length(data1.t1));
