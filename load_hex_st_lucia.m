...
fclose('all');
cruise= 'ST_LUCIA';
%datadir='/Volumes/archive/SKQ201819S/ctd/raw/SKQ201819S/';
datadir='/Volumes/data_archive/MOTIVE/Cruises/skq202417s/04_ship_data/ctd/raw/SKQ202417S/';
outdir= '/Users/kerstin/Desktop/St_Lucia/2025/';
...
xmlname= [datadir outname(1:end-10) '_' outname(end-6:end-3) 'XMLCON']
disp(['CTD file: ' ctdname])

%%
% Load calibration coefficients
disp('configuring data')
cfg=MakeCtdConfigFromXMLCON('/Volumes/data_archive/MOTIVE/Cruises/skq202417s/04_ship_data/ctd/raw/SKQ202417S/SKQ202417S_001.XMLCON');
...
data1.time = hex_time_arcticMix(icast,length(data1.t1));
