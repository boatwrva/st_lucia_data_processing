...
more off;
f.ladcpdo = sprintf('/Volumes/scienceparty_share/SR2503_scienceparty_share/LADCP/raw/_RDI_%03d.000', stn);

p.ladcp_station = stn;

f.res = sprintf('/Volumes/scienceparty_share/SR2503_scienceparty_share/LADCP/processed/%03d', stn);
f.checkpoints = sprintf('/Volumes/scienceparty_share/SR2503_scienceparty_share/LADCP/checkpoints/'); 
f.ctd = sprintf('/Volumes/scienceparty_share/SR2503_scienceparty_share/LADCP/ctd_cnv/SR2503_cast_%02d_nofilt.cnv', stn');
p.cruise_id = 'SR2503';
